...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <script src="./assets/charts-lines.js" defer=""></script>
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <h4
                    ...
                    <canvas id="line" style="display: block; height: 249px; width: 498px;" width="996" height="498" class="chartjs-render-monitor"></canvas>
