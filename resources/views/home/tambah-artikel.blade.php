              ...
              @endif
                ...
                <form action="/tambah-artikel" method="post">
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="id_volume" class="scrollbar block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-green focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" multiple="">
                        @php
                        $i=1
                        @endphp
