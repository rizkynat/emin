  ...
  <div class="flex justify-center flex-1 lg:mr-32">
        ...
        <h4
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              <form action="{{url('edit-volume/'.$volumes[0]->id_volume)}}" method="post">
                    @csrf
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">No Bank</span>
                        <select name="id_bank" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" multiple="">
                        @php
                        $i=1
                        @endphp
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <div class="relative">
                          ...
                          <input datepicker  datepicker-buttons datepicker-format="yyyy/mm/dd"  value="{{$volumes[0]->tahun}}" type="text" name="tahun" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none pl-10 p-2.5 focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="2022/08/19">
                        </div>
                      </label>

                    <label class="block text-sm mt-4">
                        <span class="text-gray-700 dark:text-gray-400">No Volume</span>
                        <input type="text" value="{{$volumes[0]->no_volume}}" name="no_volume" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Vol. 7 No.1">
                    </label>

                    <label class="block text-sm mt-4">
                        <span class="text-gray-700 dark:text-gray-400">Harga</span>
                        <input type="number" value="{{$volumes[0]->harga}}" name="harga" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Rp 300.000">
                    </label>

                    <div class="mt-4">
                    <a href="{{url('edit-volume/'.$volumes[0]->id_volume)}}">
