...
@section('content')
  ...
  <div class="flex justify-center flex-1 lg:mr-32">
        ...
        <h4
            ...
            >
            <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">Edit Volume</span></div>
        </h4>
                  ...
                  $(function(){
                    $(document).on("keypress", function(e) {
                      if(e.which == 47){
                        ...
                        window.location.assign('/list-volume');
                      }
                    });
                  });
              </script>
