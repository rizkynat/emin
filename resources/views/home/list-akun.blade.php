...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                <form action="/cari-akun" method="get" class="relative flex items-cente4r">
                  <input
                    id="input-akun"
                    name="cari"
        ...
        <main class="scrollbar h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <h4
                    ...
                    >
                    <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">List Akun</span></div>
                    </h4>
                    <div class="mb-4">
                    <a href="/register">
                    ...
                    <div class="scrollbar w-full overflow-x-auto">
                      ...
                      <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                          <th class="px-4 py-3">Nama Editor</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                          <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                              <div>
                                <p class="font-semibold">{{$editor->nama_editor}}</p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td class="px-2 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                              ...
                              <a href="{{url('hapus-akun/'.$editor->id_editor)}}">
            ...
            <div
              ...
              >
                  ...
                  <span class="flex items-center col-span-3">
                    Showing {{$editors->firstItem()}} - {{$editors->lastItem()}} of {{$editors->total()}} results
                  </span>
                  <span class="col-span-2"></span>
                  <div class="flex col-span-4 sm:mt-auto sm:justify-end mt-2">
                    <!-- Buttons -->
                    <a href="{{$editors->previousPageUrl()}}">
