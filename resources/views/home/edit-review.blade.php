...
@section('content')
  ...
  <div
        ...
        <h4
            ...
            >
            <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">Edit Review</span></div>
        </h4>
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              @endif
                    ...
                    <div class="mt-4">
                    <a href="{{url('/edit-review/'.$reviews[0]->id_review.'/'.$reviews[0]->id_artikel)}}">
