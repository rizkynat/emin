...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Edit Reviewer | Emin</title>
...
@section('content')
  ...
  <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
              <form action="/cari-reviewer" method="get" class="flex items-cente4r">
                  <input
                    id="input-reviewer"
                    name="cari"
        ...
        <h4
            ...
            >
            <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">Edit Reviewer</span></div>
        </h4>
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              @endif
                ...
                <form action="{{url('edit-reviewer/'.$reviewers[0]->id_reviewer)}}" method="post">
                    @csrf
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Nama Reviewer</span>
                        <input type="text" value="{{$reviewers[0]->nama_reviewer}}" name="nama_reviewer" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="BRI">
                    </label>

                    <label class="block text-sm mt-4">
                        <span class="text-gray-700 dark:text-gray-400">Kategori</span>
                        <select name="kategori" class="scrollbar block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" multiple="">
                            @if($reviewers[0]->kategori=='Internal')
                            <option selected value="Internal">Internal</option>
                            <option value="Eksternal">Eksternal</option>
                            @else
                            <option selected value="Eksternal">Eksternal</option>
                    ...
                    <label class="block text-sm mt-4">
                        <span class="text-gray-700 dark:text-gray-400">Instansi</span>
                        <input type="text" value="{{$reviewers[0]->instansi}}" name="instansi" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="John Orge">
                    </label>

                    <div class="mt-4">
                    <a href="{{url('edit-reviewer/'.$reviewers[0]->id_reviewer)}}">
