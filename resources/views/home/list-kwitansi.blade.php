...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>List Kwitansi | Emin</title>
  ...
  <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                <form action="/cari-kwitansi" method="get" class="relative flex items-cente4r">
                  <input
                    id="input-kwitansi"
                    name="cari"
        ...
        <main class="scrollbar h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <h4
                    ...
                    >
                    <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">List Kwitansi</span></div>
                    </h4>
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                  ...
                  <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                      ...
                      <th class="px-4 py-3">File Kwitansi</th>
                      <th class="px-4 py-3">Tanggal Kwitansi</th>
                    </tr>
                  </thead>
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <div class="flex items-center space-x-4 text-sm">
                            <a href="pdf-kwitansi/{{$kwitansi->id_kwitansi}}" target="_blank">
                            ...
                            <a href="download-kwitansi/{{$kwitansi->id_kwitansi}}" target="_blank">
                              <button class="px-1 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-primary-normal border border-transparent rounded-md active:bg-primary-normal/70 hover:bg-primary-normal/70 focus:outline-none focus:shadow-outline-green" aria-label="Insert">
            ...
            <div
              ...
              >
                  ...
                  <span class="flex items-center col-span-3">
                    Showing {{$kwitansis->firstItem()}} - {{$kwitansis->lastItem()}} of {{$kwitansis->total()}} results
                  </span>
                  <span class="col-span-2"></span>
                  <div class="flex col-span-4 sm:mt-auto sm:justify-end mt-2">
                    <!-- Buttons -->
                    <a href="{{$kwitansis->previousPageUrl()}}">
