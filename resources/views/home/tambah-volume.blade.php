                ...
                <form action="/tambah-volume" method="post">
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <div class="relative">
                          ...
                          <input datepicker datepicker-buttons datepicker-autohide datepicker-format="yyyy/mm/dd" value="{{date('Y/m/d')}}" type="text" name="tahun" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none pl-10 p-2.5 focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </div>
                    </label>
