...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Tambah Keterangan Status | Emin</title>
              ...
              @endif
                <form action="/tambah-artstatus/{{$id_artikel}}" method="post">
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="kode_status" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" multiple="">
