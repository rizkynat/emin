...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Edit Keuangan | Emin</title>
...
@section('content')
  ...
  <div class="flex justify-center flex-1 lg:mr-32">
              ...
              <form action="/cari-keuangan" method="get" class="flex items-cente4r">
                  <input
                    id="input-keuangan"
                    name="cari"
        ...
        <h4
            ...
            >
            <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">Edit Keuangan</span></div>
        </h4>
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              @endif
                ...
                <form action="{{url('edit-keuangan/'.$keuangans[0]->id_keuangan)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <label class="block text-sm mt-4">
                        <span class="text-gray-700 dark:text-gray-400">Deskripsi</span>
                        <input type="text" value="{{$keuangans[0]->deskripsi}}" name="deskripsi" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Biaya fotocopy">
                    </label>

                    <label class="block text-sm mt-4">
                    <span class="text-gray-700 dark:text-gray-400">Upload Bukti Pembayaran</span>
                    <input onchange="readURL(this);" type="file" name="foto_kwitansi" value="{{$keuangans[0]->foto_kwitansi}}" class="block text-sm mt-1 text-slate-500
                    ...
                    <div class="relative mt-2 hidden w-14 h-14 mr-3 md:block">
                            <img id="preview" class="object-cover w-full h-full border-1 rounded-sm" src="{{asset('images/keuangan/'.$keuangans[0]->foto_kwitansi)}}" alt="" loading="lazy">
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <input type="number" value="{{$keuangans[0]->nominal}}" name="nominal" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="25000">
                    </label>
                  ...
                  <label class="block text-sm mt-4">
                        ...
                        <div class="relative">
                          ...
                          <input datepicker datepicker-buttons datepicker-autohide datepicker-format="yyyy/mm/dd" type="text" value="{{$keuangans[0]->tgl_keuangan}}" name="tgl_keuangan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none pl-10 p-2.5 focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="yyyy/mm/dd">
                        </div>
                    </label>

                    <div class="mt-4">
                    <a href="{{url('/edit-keuangan/'.$keuangans[0]->id_keuangan)}}">
