              ...
              @endif
                <form action="/upload-bayar" method="post" enctype="multipart/form-data" >
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="id_invoice" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" multiple="">
                  ...
                  <label class="block text-sm mt-4">
                        ...
                        <div class="relative">
                          ...
                          <input datepicker datepicker-buttons datepicker-autohide datepicker-format="yyyy/mm/dd" type="text" name="tgl_bayar" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none pl-10 p-2.5 focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="2022/08/19">
                        </div>
                    </label>
