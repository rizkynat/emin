...
@section('content')
  ...
  <div
        ...
        <h4
            ...
            >
                    <div class="bg-primary-normal w-60 h-8 shadow-md rounded-r-3xl"><span class="ml-4 text-primary-white">Tambah Keuangan</span></div>
        </h4>
              ...
              @endif
                <form action="/tambah-keuangan" method="post" enctype="multipart/form-data" >
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <select name="status" class="scrollbar block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" multiple="">
                  ...
                  <label class="block text-sm mt-4">
                        ...
                        <div class="relative">
                          ...
                          <input datepicker datepicker-buttons datepicker-autohide datepicker-format="yyyy/mm/dd" value="{{date('Y/m/d')}}" type="text" name="tgl_keuangan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none pl-10 p-2.5 focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                        </div>
                    </label>
