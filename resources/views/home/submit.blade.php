...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <div class="flex flex-col flex-1">            
        ...
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-primary-font dark:text-purple-300">
              ...
              <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                  <form action="/submit/{{$id_invoice}}" method="post" enctype="multipart/form-data" >
                      ...
                      <label class="block text-sm mt-4">
                        ...
                        <input readonly type="text" name="id_invoice" value="{{str_pad(substr($id_invoice, 0, 4), 4, '0', STR_PAD_LEFT).'/INV/JKT/PCR/'.date('Y')}}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-primary-hover focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                    </label>
