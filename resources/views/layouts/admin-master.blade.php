    ...
    <aside
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a
            class="ml-6 text-xl font-semibold"
            href="#"
          >
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4 text-primary-font hover:text-gray-800">Dashboard</span>
              </a>
            </li>
          </ul>
          <ul id='dropdown'>
            <li class="relative px-6 py-3" x-data="{isPagesMenuOpen1: false,togglePagesMenu1() {this.isPagesMenuOpen1 = !this.isPagesMenuOpen1;}}">
              <button
              ...
              >
                ...
                >
                  ...
                  <span class="ml-4 text-primary-font hover:text-gray-800">Artikel</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isPagesMenuOpen1">
                <ul
                  ...
                  class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-primary-font rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
                  aria-label="submenu"
                >
                  <li
            ...
            <li class="relative px-6 py-3" x-data="{isPagesMenuOpen2: false,togglePagesMenu2() {this.isPagesMenuOpen2 = !this.isPagesMenuOpen2}}">
              <button
                class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
            ...
            <li class="relative px-6 py-3" x-data="{isPagesMenuOpen3: false,togglePagesMenu3() {this.isPagesMenuOpen3 = !this.isPagesMenuOpen3}}">
              <button
                class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4 text-primary-font">Dashboard</span>
              </a>
            </li>
          </ul>
          <ul>
